...
<html>
  <head>
    <title>Suzhou Unimation Co., Ltd.</title>
...
<nav class="navbar navbar-default" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Navigation column</a>
    </div>
					...
					<div class="col-md-12 column hidden-xs hidden-sm">
							...
							<div class="col-md-12 column">
							    <div class="input-group" style="float:right;padding-top:30px; ">
								 ...
								 <form action="<?php echo APP_PATH;?>index.php" method="get" target="_blank">
									...
									<input type="text" class="text" name="q" id="q"  style=" border-radius:5px;border:3px solid #0ba29a; height:42px; color:black;"  placeholder="search"/>
									<input type="submit" value="" style="background:url(<?php echo IMG_PATH;?>search.png); width:30px; height:30px;margin-left:2px;padding-bottom:8px;border:1px;" />
								</form>
						...
						<div class="row clearfix visible-md visible-lg" style="margin-bottom:20px;">
							...
							<div class="col-md-8 column" >
								...
								<li>
									<a href="<?php echo siteurl($siteid);?>" <?php if($catid) { ?> style="background-color:#fff;border:none;color:#0ba29a;" <?php  }else{ ?> style="background-color:#0ba29a;color:#fff;"<?php } ?>>Home</a>
								</li>
								<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=6e196bb1cddfb5d66935e64e7da31877&action=category&catid=9&num=8&siteid=%24siteid&order=listorder+ASC\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {$data = $content_tag->category(array('catid'=>'9','siteid'=>$siteid,'order'=>'listorder ASC','limit'=>'8',));}?>
								
								<li class="dropdown" >
										<a href="#" data-toggle="dropdown" class="dropdown-toggle" <?php if($catid!=14&&$catid!=15&&$catid!=16) { ?> style="background-color:#fff;border:none;color:#0ba29a;" <?php  }else{ ?> style="background-color:#0ba29a;color:#fff;"<?php } ?> >About us</a>
								...
								<li class="dropdown" >
										<a href="#" data-toggle="dropdown" class="dropdown-toggle" <?php if($catid!=17&&$catid!=18&&$catid!=19) { ?> style="background-color:#fff;border:none;color:#0ba29a;" <?php  }else{ ?> style="background-color:#0ba29a;color:#fff;"<?php } ?> >Product Center</a>
										<ul class="dropdown-menu" style="border:none;">
											<?php $n=1;if(is_array($data)) foreach($data AS $v) { ?>
											<li style="background-color:#0ba29a;margin-bottom:1px;">
												 <a href="<?php echo $v['url'];?>" style="background-color:#0ba29a;color:#fff;" ><?php echo $v['catname'];?></a>
								...
								<li class="dropdown" >
										<a href="#" data-toggle="dropdown" class="dropdown-toggle" <?php if($catid!=22&&$catid!=23) { ?> style="background-color:#fff;border:none;color:#0ba29a;" <?php  }else{ ?> style="background-color:#0ba29a;color:#fff;"<?php } ?> >Contact us</a>
										<ul class="dropdown-menu" style="border:none;">
											<?php $n=1;if(is_array($data)) foreach($data AS $v) { ?>
											<li style="background-color:#0ba29a;margin-bottom:1px;">
												 <a href="<?php echo $v['url'];?>" style="background-color:#0ba29a;color:#fff;" ><?php echo $v['catname'];?></a>
								...
								<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
									...
									<li >
										 <a href="../" style="background-color:#fff;border:none;color:#0ba29a;">中文|English</a>
									</li>
